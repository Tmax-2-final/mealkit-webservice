...
public class WebSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/users/id/**").permitAll();
        ...
        http.authorizeRequests().antMatchers("/**")
                .access("hasIpAddress('10.10.20.31') or hasIpAddress('127.0.0.1') " +
                        ...
                        "or hasIpAddress('192.168.95.44') or hasIpAddress('192.168.201.126')" +
                        "or hasIpAddress('15.165.139.232')")                                   // ip addr
